...
class FijkPlayerAdapter implements UnifiedPlayer {
  ...
  void _playerListener() {
    ...
    if (_player.state == FijkState.prepared ||
      ...
      _heightSubject.add(_player.value.size!.height.toInt());
      _widthSubject.add(_player.value.size!.width.toInt());
  ...
  @override
  Stream<int?> get width => _heightSubject.stream;
  @override
  Stream<int?> get height => _widthSubject.stream;
